    ...
    for (let i = 0; i < boardSize; i++) {
        for (let j = 0; j < boardSize; j++) {
            ...
            if (i === catPosition.y && j === catPosition.x) {
                ...
                catImg.src = 'imagen/gato1.png'; // Ruta de la imagen del gato
            ...
            if (i === housePosition.y && j === housePosition.x) {
                ...
                houseImg.src = 'imagen/casa2.jpg'; // Ruta de la imagen de la casa
                houseImg.alt = 'Casa';
...
function updateCatPosition() {
    ...
    const houseImg = document.createElement('img');
    houseImg.src = 'imagen/casa2.jpg'; // Ruta de la imagen del gato
